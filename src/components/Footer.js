...
const Footer = () => {
    return (
        <footer style={{backgroundColor: '#181818', color: '#b9b9b9'}}
                className="d-flex justify-content-between align-items-center p-4 p-lg-5">
            ...
            <div className="d-flex flex-column col-8 col-lg-6">
    ...
    className="bi bi-dot"/>
                ...
                <div className="d-xl-none mt-3">&copy; Cineb.net</div>
            </div>
            <div className="p-2 position-relative col-lg-3 "
